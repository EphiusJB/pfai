...
export function AuthHeading({ title, subtitle }) {
  return (
    <div className="space-y-1.5 mb-2 text-center">
...
export function TextInput({ error, className, ...props }) {
  return (
    <input
      className={cn(
        "w-full h-11 bg-card px-3.5 rounded-xl border text-base sm:text-[13px] outline-none transition-all",
      ...
      style={{
        borderColor: error ? undefined : "var(--color-card)",
        color: "var(--color-text-primary)",
        background: error ? undefined : "var(--color-card)",
      }}
      {...props}
    />
  );
  ...
  return (
    <div className="relative">
      <input
        ...
        className={cn(
          "w-full h-11 pl-3.5 pr-12 rounded-xl border text-base sm:text-[13px] outline-none transition-all",
          "placeholder:text-[var(--color-text-muted)]",
      ...
      <button
        ...
        className="absolute right-1 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-lg hover:bg-[var(--color-bg)] transition-colors"
...
export function CheckboxField({ id, label, error, ...props }) {
  return (
    <div className="space-y-1">
      <label htmlFor={id} className="flex items-start gap-2.5 cursor-pointer py-1">
        <input
          id={id}
          type="checkbox"
